...
const News = () => {
  const [selectedId, setSelectedId] = useState(NEWS_ITEMS[0]?.id);
  const selected = NEWS_ITEMS.find((n) => n.id === selectedId) || NEWS_ITEMS[0];
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          <div className="flex items-baseline justify-between mb-8">
            ...
            <span className="text-sm text-gray-500">
              {NEWS_ITEMS.length} noticia{NEWS_ITEMS.length !== 1 ? 's' : ''}
            </span>
          </div>
                    ...
                    >
                      ...
                      <div className="p-5 flex-1 flex flex-col">
                        ...
                        <div className={`mt-4 inline-flex items-center text-xs font-semibold tracking-wider transition-colors ${
                          ...
                          {isActive ? 'SELECCIONADA' : 'LEER MÁS'}
              ...
              <div className="p-6 md:p-10">
                ...
                <div className="flex items-center gap-3 text-xs text-gray-500 mb-4">
                  ...
                  <span className="font-semibold uppercase tracking-wider text-[#1a2980]">
                    {selected.featured ? 'Noticia destacada' : 'Artículo'}
                  </span>
                ...
                {gallery.length > 1 && (
                  <div className="mt-10 pt-8 border-t border-gray-100">
                    <div className="text-xs font-semibold tracking-wider text-gray-500 uppercase mb-4">
                      Galería ({gallery.length} imágenes)
                    </div>
